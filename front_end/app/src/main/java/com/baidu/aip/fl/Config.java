...
//    // license为调用sdk的人脸检测功能使用，人脸识别 = 人脸检测（sdk功能）  + 人脸比对（服务端api）
    public static String apiKey = "GEbKIip9cumjdQWZ2xsARaZR";
    public static String secretKey = "usng5UP2bPRz58dkNz05DYntNGXRmQHf";
    public static String licenseID = "drake-face-android";
     ...
     */
    public static String groupID = "caixukun";
