 ...
 * Intent intent = new Intent(FirstActivity.this, DetectLoginActivity.class);
                ...
                new Thread(){
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            String faceLoginUrl = "http://114.55.36.148:8000/login/byface";
                            String base_data = Base64.encodeToString(bytes, 0);
                            RequestBody requestBody = new MultipartBody.Builder()
                                    .setType(MultipartBody.FORM)
                                    .addFormDataPart("base_data", base_data)
                                    .build();
                            ...
                            try {
                                ...
                                if(err.equals("0")){
                                    ...
                                    Intent intent = new Intent(DetectLoginActivity.this, HomeActivity.class);
                            ...
                            //返回json中有三个字段,msg(内容为登录成功的token)，err(1失败，0成功)和username
                        } catch (IOException e) {
                            e.printStackTrace();
                        }
