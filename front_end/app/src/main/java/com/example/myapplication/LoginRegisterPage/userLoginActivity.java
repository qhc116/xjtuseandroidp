...
public class userLoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (sp.getBoolean("main", false)&&sp.getString("login","").equals("abc"))
        {
                    ...
                    public void run() {
                        ...
                        try {
                            ...
                            if (err.equals("0")) {
                                ...
                                saveData(jsonObject.getString("msg"));
                                startActivity(intent);
                                userLoginActivity.this.finish();
                            } else {
  ...
  private void saveData(String message) {
      SharedPreferences spf = getSharedPreferences("Minfo", MODE_PRIVATE);
      SharedPreferences.Editor edit = sp.edit();
      edit.putString("login", message);
      edit.commit();
  }
